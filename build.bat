...
set SOLUTION_FILE=dem_to_stl.sln
set BUILD_CONFIG=release
set BUILD_TYPE=rebuild

call :rewrite_file "dem_to_stl\Form1.resx"
call :rewrite_file "dem_to_stl\Properties\Resources.resx"
call :rewrite_file "dem_to_stl\dem_to_stl.csproj"
